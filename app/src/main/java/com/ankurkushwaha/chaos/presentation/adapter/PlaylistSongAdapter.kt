...
) : ListAdapter<Song, PlaylistSongAdapter.SongViewHolder>(PlaylistSongDiffCallback()) {
...
private class PlaylistSongDiffCallback : DiffUtil.ItemCallback<Song>() {
